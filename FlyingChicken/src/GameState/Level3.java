...
public class Level3 extends GameState
{
    ...
    public void init()
    {
        try
        {   
            image_levelTable = ImageIO.read(new FileImageInputStream(new File("LevelLabel.png")));     //Level Label IMAGE
            image_timeTable = ImageIO.read(new FileImageInputStream(new File("TimeLabel.png")));       //TIME LABEL IMAGE
    ...
    public void update()
    {
        //İlk 15 saniyeden sonra bir kere kedi-bulutları hızlandır
    ...
    public void draw(Graphics2D g)
    {
       ...
       {     
            ...
            else
            {
                ...
                /*
                //HITBOX TEST:
                g.drawRect(chickenX+5, 0, 55, 63);
                g.setColor(Color.white);
                g.drawRect(cats.get(i).getCatX()+12, cats.get(i).getCatY()+30, image_evilcat.getWidth()/24+12, image_evilcat.getHeight()/24+3);
       ...
       g.drawString((String.valueOf(3)), 135, 520);
